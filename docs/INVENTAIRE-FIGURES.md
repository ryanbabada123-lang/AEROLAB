...
| --- | --- | --- |
| p1·1 · p1·2 | Décroissance de la température avec l'altitude, jusqu'à la tropopause | **SCHÉMA** — les deux sont quasi identiques, une seule à redessiner |
...
| p6·1 | Saturation en O₂ de l'hémoglobine selon l'altitude | **SCHÉMA** — courbe pure, excellent candidat |
...
| p16·1 | Check-list M.A. F.O.R.M.E. | TABLEAU |

**Bilan : 8 schémas distincts à redessiner**, 5 images demandant une source
libre, 1 tableau à transcrire. Soit **la moitié** des figures.
...
figures se redessinent. Le Cours 3, lui, laisse voir beaucoup d'écorchés 3D —
